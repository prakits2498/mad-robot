 ...
 * various constructor arguments provided by XMLWizard:
 * <ul>
 * <li>{@link com.madrobot.di.wizard.xml.Mapper}: The current mapper chain of the XMLWizard
 * instance.</li>
 * <li>{@link ClassLoader}: The class loader used by the XMLWizard instance to deserialize the
 * objects.</li>
 * <li>{@link com.madrobot.di.wizard.xml.converters.ReflectionProvider}: The reflection
 * provider used by the reflection based converters of the current XMLWizard instance.</li>
 * <li>{@link com.madrobot.di.wizard.xml.converters.ConverterLookup}: The lookup for converters
 ...
 * {@link com.madrobot.di.wizard.xml.annotations.Converters}.</li>
 * </ul>
 * <p>
 ...
 * {@link com.madrobot.di.wizard.xml.AnnotationMapper} can only handle these two
