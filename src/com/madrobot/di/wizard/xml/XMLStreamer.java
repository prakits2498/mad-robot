 ...
 * additionally the XMLWizarda that was used to serialize the object graph. Such a stream can
...
public class XMLStreamer {
     ...
     * @throws com.madrobot.di.wizard.xml.XMLWizardException if the object cannot be serialized
     * @since 1.2
     * @see #toXML(XMLWizard, Object, Writer)
     */
    public String toXML(XMLWizard xstream, Object obj) throws ObjectStreamException {
     ...
     * should use {@link XMLStreamer#fromXML(Reader)} or one of the other overloaded
     ...
     * @since 1.2
     */
    public void toXML(XMLWizard xstream, Object obj, Writer out)
            throws IOException {
     ...
     * @throws com.madrobot.di.wizard.xml.XMLWizardException if the object cannot be deserialized
     * @since 1.2
     * @see #toXML(XMLWizard, Object, Writer)
     */
