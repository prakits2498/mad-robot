 ...
 * <td>color</td>
 * <td>#ff6E6E6E</td>
 * <td>Border color for the Color Picker</td>
 * </tr>
 * <tr>
 * <td><code>selectorRadius</code></td>
 * <td>dimension</td>
 * <td>5dp</td>
 * <td>Palette selector radius</td>
 * </tr>
 * <tr>
 * <td><code>selectorOuterColor</code></td>
 * <td>color</td>
 * <td>#ffdddddd</td>
 * <td>Palette color selector outer color</td>
 * </tr>
 * <tr>
 * <td><code>selectorInnerColor</code></td>
 * <td>color</td>
 * <td>#ff000000</td>
 * <td>Palette color selector inner color</td>
 * </tr>
 * <tr>
 * <td><code>sliderPanelSelectorColor</code></td>
 * <td>color</td>
 * <td>#ff1c1c1c</td>
 * <td>Hue slider selector  color</td>
 * </tr>
 * <tr>
 * <td><code>sliderPanelPadding</code></td>
 * <td>dimension</td>
 * <td>10dp</td>
 * <td>Space between the color selector and hue selector panel</td>
 * </tr>
 * <tr>
 * <td><code>sliderPanelWidth</code></td>
 * <td>dimension</td>
 * <td>30dp</td>
 * <td>Width of the hue selector panel</td>
 * </tr>
 * </table>
 * </p>
 */
public class ColorPickerView extends View {
	...
	/**
	 * Listener for notifying color changed events.
	 * 
	 ...
	 */
	private float mPanelPadding = 10f;
	...
	private int trackerInnerColor = 0xff000000;

	private int trackerOuterColor = 0xffdddddd;
	...
	private void drawSatValPanel(Canvas canvas) {
		...
		mSatValTrackerPaint.setColor(trackerInnerColor);
		canvas.drawCircle(p.x, p.y, paletteCircleTrackerRadius - 1f * mDensity, mSatValTrackerPaint);
	...
	private int getPrefferedHeight() {
		...
		if (mShowAlphaPanel) {
			height += mPanelPadding + ALPHA_PANEL_HEIGHT;
		}
	...
	private int getPrefferedWidth() {
		...
		if (mShowAlphaPanel) {
			width -= (mPanelPadding + ALPHA_PANEL_HEIGHT);
		}

		return (int) (width + huePanelWidth + mPanelPadding);
	...
	private void init() {
		...
		mPanelPadding = mPanelPadding * mDensity;
	...
	private void initAttributes(Context context, AttributeSet attrs) {
		TypedArray styledAttrs = context.obtainStyledAttributes(attrs, R.styleable.ColorPickerView);
		mBorderColor = styledAttrs.getColor(R.styleable.ColorPickerView_borderColor, mBorderColor);
		trackerInnerColor = styledAttrs.getColor(R.styleable.ColorPickerView_selectorInnerColor, trackerInnerColor);
		trackerOuterColor = styledAttrs.getColor(R.styleable.ColorPickerView_selectorOuterColor, trackerOuterColor);
		mSliderTrackerColor = styledAttrs.getColor(R.styleable.ColorPickerView_sliderPanelSelectorColor,
				mSliderTrackerColor);
		mPanelPadding = styledAttrs.getDimension(R.styleable.ColorPickerView_sliderPanelPadding, mPanelPadding);
		huePanelWidth = styledAttrs.getDimension(R.styleable.ColorPickerView_sliderPanelWidth, huePanelWidth);
		paletteCircleTrackerRadius=styledAttrs.getDimension(R.styleable.ColorPickerView_selectorRadius, paletteCircleTrackerRadius);
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (!mShowAlphaPanel) {
			height = (int) (widthAllowed - mPanelPadding - huePanelWidth);

			// If calculated height (based on the width) is more than the
			// allowed height.
			if (height > heightAllowed) {
				height = heightAllowed;
				width = (int) (height + mPanelPadding + huePanelWidth);
			} else {
				width = widthAllowed;
			}
		} else {

			width = (int) (heightAllowed - ALPHA_PANEL_HEIGHT + huePanelWidth);

			if (width > widthAllowed) {
				width = widthAllowed;
				height = (int) (widthAllowed - huePanelWidth + ALPHA_PANEL_HEIGHT);
			} else {
				height = heightAllowed;
			}
	...
	private void setUpHueRect() {
		...
		float bottom = dRect.bottom - BORDER_WIDTH_PX - (mShowAlphaPanel ? (mPanelPadding + ALPHA_PANEL_HEIGHT) : 0);
		float right = dRect.right - BORDER_WIDTH_PX;
	...
	private void setUpSatValRect() {
		...
		if (mShowAlphaPanel) {
			panelSide -= mPanelPadding + ALPHA_PANEL_HEIGHT;
		}
