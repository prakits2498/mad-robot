 ...
 * all classes derived from {@link com.madrobot.net.client.SocketClient}, you
 * must first connect to the server with
 * {@link com.madrobot.net.client.SocketClient#connect connect } before doing
 ...
 * {@link com.madrobot.net.client.mail.SMTP#getReplyCode getReplyCode } after a
 * success or failure.
 * <p>
 ...
 * {@link com.madrobot.net.client.mail.SMTPConnectionClosedException} .
 ...
 * an {@link com.madrobot.net.client.mail.SMTPConnectionClosedException} , you
 ...
 * {@link com.madrobot.net.client.mail.SMTP#getReplyCode getReplyCode },
 * {@link com.madrobot.net.client.mail.SMTP#getReplyString getReplyString }, and
 * {@link com.madrobot.net.client.mail.SMTP#getReplyStrings getReplyStrings}.
 * <p>
 ...
 * throw a {@link com.madrobot.net.client.mail.MalformedServerReplyException} ,
...
public class SMTPClient extends SMTP {
	 ...
	 * {@link com.madrobot.net.client.mail.SimpleSMTPHeader} class to construct
	 * a bare minimum header. To construct more complicated headers you should
	 ...
	 * {@link #completePendingCommand completePendingCommand() * } to finalize
	 * the transaction and returns its success or failure.
	 * <p>
	 * 
	 * @param message
