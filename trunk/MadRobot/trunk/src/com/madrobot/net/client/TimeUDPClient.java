 ...
 * socket with {@link com.madrobot.net.client.DatagramSocketClient#open open }
 * and call {@link #getTime getTime } or {@link #getTime getDate } to retrieve
 * the time. Then call
 * {@link com.madrobot.net.client.DatagramSocketClient#close close } to close
 * the connection properly. Unlike
 * {@link com.madrobot.io.net.client.time.TimeTCPClient}, successive calls to
