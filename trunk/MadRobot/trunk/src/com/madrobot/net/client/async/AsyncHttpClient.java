 ...
 * additional parameters by passing a {@link AsyncHttpRequestParams} instance,
...
public class AsyncHttpClient {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void get(String url, AsyncHttpRequestParams params,
			AsyncHttpResponseHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void post(String url, AsyncHttpRequestParams params,
			AsyncHttpResponseHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void put(Context context, String url, AsyncHttpRequestParams params,
			AsyncHttpResponseHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void put(String url, AsyncHttpRequestParams params,
			AsyncHttpResponseHandler responseHandler) {
