...
public class MethodDescriptor extends FeatureDescriptor {
	...
	/*
	 * public String toString() { String message = "name=" + getName(); Class
	 * cls = getClass0(); if (cls != null) { message += ", class="; message +=
	 * cls.getName(); } String[] names = getParamNames(); if (names != null) {
	 * for (int i = 0; i < names.length; i++) { message += ", param=" +
	 * names[i]; } } return message; }
	 */
