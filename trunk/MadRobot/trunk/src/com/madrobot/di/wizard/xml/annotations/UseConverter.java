 ...
 * <ul>
 * <li>{@link com.madrobot.di.wizard.xml.Mapper}: The current mapper chain of
 ...
 * <li>{@link com.madrobot.di.wizard.xml.converters.ReflectionProvider}: The
 * reflection provider used by the reflection based converters of the current
 * XMLWizard instance.</li>
 * <li>{@link com.madrobot.di.wizard.xml.converters.ConverterLookup}: The lookup
 * for converters handling a special type.</li>
 * <li>{@link com.madrobot.di.wizard.xml.core.JVM}: Utility e.g. to load
 * classes.</li>
 ...
 * {@link com.madrobot.di.wizard.xml.converters.SingleValueConverter} extend
 * this interface. The {@link com.madrobot.di.wizard.xml.AnnotationMapper} can
