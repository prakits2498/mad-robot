 ...
 ******************************************************************************/
package com.madrobot.di.xml.annotation;
...
import com.madrobot.di.xml.XMLWizard;
import com.madrobot.di.xml.converter.ConverterMatcher;
 ...
 * <li>{@link com.madrobot.di.xml.converter.ReflectionProvider}: The reflection
 * provider used by the reflection based converters of the current XMLWizard
 * instance.</li>
 * <li>{@link com.madrobot.di.xml.converter.ConverterLookup}: The lookup for
 ...
 * {@link com.madrobot.di.xml.annotation.Converters}.</li>
 * </ul>
 * <p>
 * Note, the annotation matches a {@link ConverterMatcher}.
 * {@link com.madrobot.di.xml.converter.ConverterMatcher} as well as
 * {@link com.madrobot.di.xml.converter.SingleValueConverter} extend this
