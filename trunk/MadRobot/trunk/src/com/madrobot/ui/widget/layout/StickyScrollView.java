...
/**
 * Sticky scroll view makes the views marked as "sticky" to stay on top while
 * scrolling.
 * <p>
 * Use the StickyScrollView instead of the ScrollView. To mark a view as
 * "sticky", set the tag of the view as "sticky" of its a view that does not
 * need constant updation (like TextView, ImageView etc.) and "sticky-nc" for
 * views that are constantly updated(Buttons, ProgressBars etc.). <br/>
 * <b>Demo</b><br/>
 * <center><OBJECT CLASSID="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
 * WIDTH="428" HEIGHT="716" CODEBASE
 * ="http://active.macromedia.com/flash5/cabs/swflash.cab#version=7,0,0,0">
 * <PARAM NAME=movie
 * VALUE="../../../../../resources/demos/stickyscrollview.swf"> <PARAM NAME=play
 * VALUE=true> <PARAM NAME=loop VALUE=false> <PARAM NAME=wmode
 * VALUE=transparent> <PARAM NAME=quality VALUE=low> <EMBED
 * SRC="../../../../../resources/demos/stickyscrollview.swf" WIDTH=428
...
public class StickyScrollView extends ScrollView {
	...
	/**
	 * Tag for views that should stick and have non-constant drawing. e.g.
	 * Buttons, ProgressBars etc
	 */
	public static final String STICKY_TAG_NONCONSTANT = "sticky-nc";
