...
public class CircleUtils {
	 ...
	 */
	public static boolean isColliding(PointF circle1Center, float circle1Radius,
			PointF circle2Center, float circle2Radius) {
	 ...
	 * @return
	 */
	public static boolean isPointInCircle(float x, float y, float circleX, float circleY,
			float circleRadius) {
