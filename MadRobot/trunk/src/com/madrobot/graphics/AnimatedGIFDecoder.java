...
/**
 * Parses and decodes static or animated .GIF files.
 * <p>
 * Because Android's native GIF animator {@link android.graphics.Movie} does not
 * do a good job at rendering .GIF files
 * </p>
 * 
 * @author ekent4
 * 
...
public class AnimatedGIFDecoder {
	...
	private int blockSize = 0; // block size last graphic control extension
								// info
	private int dispose = 0; // 0=no action; 1=leave in place; 2=restore to
