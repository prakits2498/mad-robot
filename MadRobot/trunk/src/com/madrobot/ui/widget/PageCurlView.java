...
/**
 * A view that curls the end of the page. The curled end can be flipped like the
 * iBooks app.
 * <p>
 * Page can be flipped by double tap as well <br/>
 * <b>Usage</b>
 * 
 * <pre>
 * 	&lt;com.madrobot.ui.widgets.PageCurlView
 * 		android:layout_width="fill_parent"
 * 		android:layout_height="fill_parent"
 * 		android:id="@+id/dcgpagecurlPageCurlView1"
 * 		&lt;!--Bitmap to be used for the top drawable --&gt;
 * 		android:top_Drawable="@drawable/topDraw"
 * 		&lt;!--Bitmap to be used for the bottom drawable --&gt;
 * 		android:top_Drawable="@drawable/bottomDraw"
...
public class PageCurlView extends View {
	...
	// }
	//
	Bitmap firstDrawable;
	Bitmap secondDrawable;
	...
	public PageCurlView(Context context, AttributeSet attrs) {
		...
		// Get the data from the XML AttributeSet
		{
			...
			BitmapDrawable d = (BitmapDrawable) first;
			firstDrawable = d.getBitmap();

			first = a.getDrawable(R.styleable.PageCurlView_bottom_Drawable);
			if (first == null) {
				throw new IllegalArgumentException("Second drawable is not set");
			}
			d = (BitmapDrawable) first;
			secondDrawable = d.getBitmap();
	...
	private final void init(Context context) {
		...
		mPages.add(firstDrawable);
		mPages.add(secondDrawable);
