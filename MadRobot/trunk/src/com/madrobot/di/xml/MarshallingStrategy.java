...
interface MarshallingStrategy {
	...
	void marshal(HierarchicalStreamWriter writer, Object obj, ConverterLookup converterLookup,
			Mapper mapper, DataHolder dataHolder);

	Object unmarshal(Object root, HierarchicalStreamReader reader, DataHolder dataHolder,
