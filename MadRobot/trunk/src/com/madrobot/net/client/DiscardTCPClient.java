 ...
 * connection with {@link com.madrobot.io.net.client.net.SocketClient#connect
 * connect } and call {@link #getOutputStream getOutputStream() } to retrieve
 * the discard output stream. Don't close the output stream when you're done
 * writing to it. Rather, call
 * {@link com.madrobot.io.net.client.net.SocketClient#disconnect disconnect } to
 * clean up properly.
 * <p>
 * <p>
 * 
