...
public class Message {
	...
	public Message(CharSequence textMessage) {
		this(OPCODE_TEXT, StringUtils.getUTF8Bytes(textMessage), true);
	}
	...
	/**
	 * @return true if the message is generated by or targeted at users. false
	 *         if it is system framing.
	 */
	...
	public CharSequence getMessageText() {
		return StringUtils.fromUTF8Bytes(messageData);
	}
	...
	public String toString() {
		if (opcode == OPCODE_TEXT)
			return getMessageText().toString();
