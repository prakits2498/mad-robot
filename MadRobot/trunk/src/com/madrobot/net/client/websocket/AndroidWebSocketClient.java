...
/**
 * Android specific WebSocket client that interfaces with the Looper to provide
 * threading control.
 * 
 * @author stella
 * 
 */
public class AndroidWebSocketClient extends WebSocket {
	 ...
	 */
	public AndroidWebSocketClient(String url, String... requestedProtocols) {
